...
class ThreadPool:
    ...
    def poll(self, block=False, useExceptions=False):
        """Process any new results in the queue."""
        while True:
            # still results pending?
            # Constantly throwing exceptions for no pending results seems to be hard on the CPU
            # So we'll make this selectable instead of the default behavior
            # Modified: 03/09/09 Gary D. Foster <garyf@elastra.com>
